...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // If you are using a pre-configured hotend then you can use one of the value sets by uncommenting ia
 ...
 */
  ...
  #define PROBE_PT_1_Y (Y_MAX_POS-10)
  #define PROBE_PT_2_X (X_MIN_POS+X_PROBE_OFFSET_FROM_EXTRUDER)
  #define PROBE_PT_2_Y (Y_MIN_POS+10)
  #define PROBE_PT_3_X (X_MAX_POS-10)
  #define PROBE_PT_3_Y (Y_MIN_POS+10)
#endif
